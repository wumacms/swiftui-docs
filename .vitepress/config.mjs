...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      { text: '首页', link: '/' },
      {
        text: '更多教程', activeMatch: '^/(100days|base|custom_views|core|network|geometry|refactor|animation|purchase|thinking|grid|advanced|lifecycle)/', items: [
          {
            text: '100 天 SwiftUI',
            link: '/100days/',
            activeMatch: '^/100days/'
      ...
      '/100days/': [
        {
          ...
          collapsed: false,
          items: [
            { text: '内容简介', link: '/100days/' }  // 👈 指向 index.md
          ]
        },
        {
          text: '课前准备',
          collapsed: false,
          items: [
            { text: '如何成为一名iOS开发者', link: '/100days/【课前阅读】如何成为一名iOS开发者' },
          ]
        },
        {
          text: 'Swift 基础 (第01-15天)',
          collapsed: false,
          items: [
            { text: '第01天 变量、常量、字符串和数字', link: '/100days/第01天_变量、常量、字符串和数字' },
            { text: '第02天 布尔值、字符串插值', link: '/100days/第02天_布尔值、字符串插值' },
            { text: '第03天 数组、字典、集合和枚举', link: '/100days/第03天_数组、字典、集合和枚举' },
            { text: '第04天 类型注解', link: '/100days/第04天_类型注解' },
            { text: '第05天 条件语句、Switch 语句和三元运算符', link: '/100days/第05天_条件语句、Switch语句和三元运算符' },
            { text: '第06天 循环', link: '/100days/第06天_循环' },
            { text: '第07天 函数、参数和返回值', link: '/100days/第07天_函数、参数和返回值' },
            { text: '第08天 默认值、抛出异常', link: '/100days/第08天_默认值、抛出异常' },
            { text: '第09天 闭包、函数作为参数', link: '/100days/第09天_闭包、函数作为参数' },
            { text: '第10天 结构体、计算属性和属性观察者', link: '/100days/第10天_结构体、计算属性和属性观察者' },
            { text: '第11天 访问控制、静态属性和方法', link: '/100days/第11天_访问控制、静态属性和方法' },
            { text: '第12天 类、继承', link: '/100days/第12天_类、继承' },
            { text: '第13天 协议、扩展', link: '/100days/第13天_协议、扩展' },
            { text: '第14天 可选类型、空合运算符', link: '/100days/第14天_可选类型、空合运算符' },
            { text: '第15天 复习：一小时掌握 Swift 核心知识', link: '/100days/第15天_复习：一小时掌握Swift核心知识' }
          ]
        },
        {
          text: 'SwiftUI 项目实战 (第16-100天)',
          collapsed: false,
          items: [
            { text: '第16天 SwiftUI项目1 第一部分', link: '/100days/第16天_SwiftUI项目1_第一部分' },
            { text: '第17天 SwiftUI项目1 第二部分', link: '/100days/第17天_SwiftUI项目1_第二部分' },
            { text: '第18天 SwiftUI项目1 第三部分', link: '/100days/第18天_SwiftUI项目1_第三部分' },
            { text: '第19天 挑战日', link: '/100days/第19天_挑战日' },
            { text: '第20天 项目2 第一部分', link: '/100days/第20天_项目2_第一部分' },
            { text: '第21天 项目2 第二部分', link: '/100days/第21天_项目2_第二部分' },
            { text: '第22天 项目2 第三部分', link: '/100days/第22天_项目2_第三部分' },
            { text: '第23天 项目3 第一部分', link: '/100days/第23天_项目3_第一部分' },
            { text: '第24天 项目3 第二部分', link: '/100days/第24天_项目3_第二部分' },
            { text: '第25天 复习2', link: '/100days/第25天_复习2' },
            { text: '第26天 项目4第一部分', link: '/100days/第26天_项目4第一部分' },
            { text: '第27天 项目4第二部分', link: '/100days/第27天_项目4第二部分' },
            { text: '第28天 项目4第三部分', link: '/100days/第28天_项目4第三部分' },
            { text: '第29天 项目5第一部分', link: '/100days/第29天_项目5第一部分' },
            { text: '第30天 项目5第二部分', link: '/100days/第30天_项目5第二部分' },
            { text: '第31天 项目5第三部分', link: '/100days/第31天_项目5第三部分' },
            { text: '第32天 项目6第一部分', link: '/100days/第32天_项目6第一部分' },
            { text: '第33天 项目6第二部分', link: '/100days/第33天_项目6第二部分' },
            { text: '第34天 项目6第三部分', link: '/100days/第34天_项目6第三部分' },
            { text: '第35天 复习3', link: '/100days/第35天_复习3' },
            { text: '第36天 项目7 第一部分', link: '/100days/第36天_项目7_第一部分' },
            { text: '第37天 项目7 第二部分', link: '/100days/第37天_项目7_第二部分' },
            { text: '第38天 项目7 第三部分', link: '/100days/第38天_项目7_第三部分' },
            { text: '第39天 项目8 第一部分', link: '/100days/第39天_项目8_第一部分' },
            { text: '第40天 项目8 第二部分', link: '/100days/第40天_项目8_第二部分' },
            { text: '第41天 项目8 第三部分', link: '/100days/第41天_项目8_第三部分' },
            { text: '第42天 项目8 第四部分', link: '/100days/第42天_项目8_第四部分' },
            { text: '第43天 项目9 第一部分', link: '/100days/第43天_项目9_第一部分' },
            { text: '第44天 项目9 第二部分', link: '/100days/第44天_项目9_第二部分' },
            { text: '第45天 项目9 第三部分', link: '/100days/第45天_项目9_第三部分' },
            { text: '第46天 项目9 第四部分', link: '/100days/第46天_项目9_第四部分' },
            { text: '第47天 里程碑 项目7-9', link: '/100days/第47天_里程碑_项目7-9' },
            { text: '第48天 拓展你的视野', link: '/100days/第48天_拓展你的视野' },
            { text: '第49天 项目10 第一部分', link: '/100days/第49天_项目10_第一部分' },
            { text: '第50天 项目10 第二部分', link: '/100days/第50天_项目10_第二部分' },
            { text: '第51天 项目10 第三部分', link: '/100days/第51天_项目10_第三部分' },
            { text: '第52天 项目10 第四部分', link: '/100days/第52天_项目10_第四部分' },
            { text: '第53天 项目11 第一部分', link: '/100days/第53天_项目11_第一部分' },
            { text: '第54天 项目11 第二部分', link: '/100days/第54天_项目11_第二部分' },
            { text: '第55天 项目11 第三部分', link: '/100days/第55天_项目11_第三部分' },
            { text: '第56天 项目11 第四部分', link: '/100days/第56天_项目11_第四部分' },
            { text: '第57天 项目12 第一部分', link: '/100days/第57天_项目12_第一部分' },
            { text: '第58天 项目12 第二部分', link: '/100days/第58天_项目12_第二部分' },
            { text: '第59天 项目12 第三部分', link: '/100days/第59天_项目12_第三部分' },
            { text: '第60天 里程碑：项目10-12', link: '/100days/第60天_里程碑：项目10-12' },
            { text: '第61天 SwiftData 时间', link: '/100days/第61天_SwiftData时间' },
            { text: '第62天 项目13 第一部分', link: '/100days/第62天_项目13_第一部分' },
            { text: '第63天 项目13 第二部分', link: '/100days/第63天_项目13_第二部分' },
            { text: '第64天 项目13 第三部分', link: '/100days/第64天_项目13_第三部分' },
            { text: '第65天 项目13 第四部分', link: '/100days/第65天_项目13_第四部分' },
            { text: '第66天 项目13 第五部分', link: '/100days/第66天_项目13_第五部分' },
            { text: '第67天 项目13 第六部分', link: '/100days/第67天_项目13_第六部分' },
            { text: '第68天 项目14 第一部分', link: '/100days/第68天_项目14_第一部分' },
            { text: '第69天 项目14 第二部分', link: '/100days/第69天_项目14_第二部分' },
            { text: '第70天 项目14 第三部分', link: '/100days/第70天_项目14_第三部分' },
            { text: '第71天 项目14 第四部分', link: '/100days/第71天_项目14_第四部分' },
            { text: '第72天 项目14 第五部分', link: '/100days/第72天_项目14_第五部分' },
            { text: '第73天 项目14 第六部分', link: '/100days/第73天_项目14_第六部分' },
            { text: '第74天 项目15 第一部分', link: '/100days/第74天_项目15_第一部分' },
            { text: '第75天 项目15 第二部分', link: '/100days/第75天_项目15_第二部分' },
            { text: '第76天 项目15 第三部分', link: '/100days/第76天_项目15_第三部分' },
            { text: '第77天 里程碑 项目13-15', link: '/100days/第77天_里程碑_项目13-15' },
            { text: '第78天 MapKit 时间', link: '/100days/第78天_MapKit时间' },
            { text: '第79天 项目16 第一部分', link: '/100days/第79天_项目16_第一部分' },
            { text: '第80天 项目16 第二部分', link: '/100days/第80天_项目16_第二部分' },
            { text: '第81天 项目16 第三部分', link: '/100days/第81天_项目16_第三部分' },
            { text: '第82天 项目16 第四部分', link: '/100days/第82天_项目16_第四部分' },
            { text: '第83天 项目16 第五部分', link: '/100days/第83天_项目16_第五部分' },
            { text: '第84天 项目16 第六部分', link: '/100days/第84天_项目16_第六部分' },
            { text: '第85天 项目16 第七部分', link: '/100days/第85天_项目16_第七部分' },
            { text: '第86天 项目17 第一部分', link: '/100days/第86天_项目17_第一部分' },
            { text: '第87天 项目17 第二部分', link: '/100days/第87天_项目17_第二部分' },
            { text: '第88天 项目17 第三部分', link: '/100days/第88天_项目17_第三部分' },
            { text: '第89天 项目17 第四部分', link: '/100days/第89天_项目17_第四部分' },
            { text: '第90天 项目17 第五部分', link: '/100days/第90天_项目17_第五部分' },
            { text: '第91天 项目17 第六部分', link: '/100days/第91天_项目17_第六部分' },
            { text: '第92天 项目18 第一部分', link: '/100days/第92天_项目18_第一部分' },
            { text: '第93天 项目18 第二部分', link: '/100days/第93天_项目18_第二部分' },
            { text: '第94天 项目18 第三部分', link: '/100days/第94天_项目18_第三部分' },
            { text: '第95天 里程碑 项目16-18', link: '/100days/第95天_里程碑_项目16-18' },
            { text: '第96天 项目19 第一部分', link: '/100days/第96天_项目19_第一部分' },
            { text: '第97天 项目19 第二部分', link: '/100days/第97天_项目19_第二部分' },
            { text: '第98天 项目19 第三部分', link: '/100days/第98天_项目19_第三部分' },
            { text: '第99天 项目19 第四部分', link: '/100days/第99天_项目19_第四部分' },
            { text: '第100天 期末考试', link: '/100days/第100天_期末考试' }
          ]
        }
      ],
      '/base/': [
